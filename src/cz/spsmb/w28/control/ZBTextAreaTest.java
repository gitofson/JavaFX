...
// TextArea slouží pro víceřádkovou reprezentaci vstupu textu. Znak nové řádky odstartuje nový odstavec.
// Vlastnosti:
// prefColumnCount - šířka ovl. prvku, výchozí hodnota je 32,
// prefRowCount    - výška ovl. prvku, výchozí hodnota ja 10,
// scrollLeft      - počet pixelů, o které se má scrolovat vlevo,
// scrollTop       - počet pixelů, o které se má scrolovat nahoru,
// wrapText        - zalomení textu, pokud jeho délka přesáhne šířku ovl. prvku.

public class ZBTextAreaTest extends Application {
