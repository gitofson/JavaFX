...
// SplitPane aranžuje vícero uzlů horizontálně, nebo vertikálně a odděluje je oddělovačem (divider). Ten může být
// přesouván uživatelem tak, že se jeden uzel může na úkor druhého rozšiřovat, či zužovat.
// Vlastnosti:
// dividerPosition    - pozice oddělovače, pokud je jeden,
// dividerPositions   - pozice oddělovačů, pokud jich je více.


public class ZISplitPaneTest extends Application {
