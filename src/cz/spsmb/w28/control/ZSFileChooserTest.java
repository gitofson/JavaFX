...
// initialDirectory     - inicializační adresář, kde bude dialog zobraye,
// initialFileName      - typicky pro file save dialog, využití záleží na OS,
// extensionFilters     - filtry pro dialog. Příklad viz program.
//
// Zobrazení dialogu:
// showOpenDialog(Window ownerWindow)           - vrací File objekt
// showOpenMultipleDialogWindow ownerWindow()-  - vrací List<File>
// showSaveDialog(Window ownerWindow)           - vrací File objekt

public class ZSFileChooserTest extends Application {
