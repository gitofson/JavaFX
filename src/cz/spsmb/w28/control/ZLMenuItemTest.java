...
// Program kreslí tvary použitím menu. Používá všechny typy položek menu. Root je BorderPane, jeho top část je menu,
// center pak plátno(canvas), kde se tvary vykreslují.
public class ZLMenuItemTest extends Application {
