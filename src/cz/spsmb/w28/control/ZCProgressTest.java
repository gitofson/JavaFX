...
// Pro zobrazení progresu JavaFX disponuje následujícími třídami:
// ProgresIndicator
// ProgressBar

//Obojí může být buď deterministické (determinate), nebo nedeterministické (indeterminate).

//Vlastnosti:
// indeterminate - pokud je true, tak se místo zobrazení pevného ukazatele používá nějaká animace
// progress      - číslo od 0 (0%) do 1.0(100%)

public class ZCProgressTest extends Application {
