...
// CheckBox je třístavový ovládací prvek. Následující stavy:
// checked   (true)
// unchecked (false)
// undefined (unknown)

// Ve výchozím nastavení je pouze dvoustavový (checked, unchecked). Vlastnost
// BooleanProperty allowIntermidiate (default false)
// určuje, zda je třetí stav dostupný ve výběru.

// Vlastnost intermidiate třídy CheckBox určuje, zda je v undefined stavu. Trochu to zesložiťuje detekci přechodu stavů.
// Ukázáno na následujícím příkladě, kde se handler věsí na vlastnosti selected i intermediate:
//        agreeCbx.selectedProperty().addListener(this::changed);
//        agreeCbx.indeterminateProperty().addListener(this::changed);

public class ICheckBoxTest extends Application {
