...
// Pokud bychom chtěli změnit výchozí počet položek (10) v pop-up seznamu, použijeme vlastnost visibleRowCount

//Třída Cell je Labeled ovládací prvek pro zobrazení textového, či grafického obsahu. Položky kombo boxu  mohou být
...
// nedoporučuje se, vybraná položka zmizí z nabídky
        /*
        Label shapeLbl = new Label("Shape: ");
        ComboBox<HBox> shapes = new ComboBox<>();
        shapes.getItems().addAll(
