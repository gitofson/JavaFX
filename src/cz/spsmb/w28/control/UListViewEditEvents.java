...
// Editovatelný ListView může odpálit 3 typy událostí:
// - editStart
// - editCommit
// - editCancel
// ListView.EditEvent<T> je statická vnitřní třída, která tyto události reprezentuje. Metody:
// getIndex()       - vrátí index právě editované položky,
// getNewValue()    - vrátí novou vstupní hodnotu,
// getSource()      - vrátí referenci na ListView, který událost odpálil.
// Pro nastavení handlerů událostí  slouží vlastnosti onEditStart, onEditCommit, onEditCancel.

public class UListViewEditEvents extends Application {
