...
// Tlačítka (buttons) - existují 3 typy ovládacích prvků reprezentující tlačítka:
// - command button - tlačítko, které spustá nějaký příkaz, pokud je aktivováno. Příklady: Button, Hyperlink, MenuButton
// - choice buttons - tlačítka pro prezentaci výběru různých voleb. Příklady: ToggleButton, CheckBox a RadioButton
