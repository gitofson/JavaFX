...
// Třída RadioButton je zděděná po ToggleButton. Oproti ToggleButton má následující odlišnosti:
// - jiný vzhled
// - pokud je použita ve skupině, není možné aby nebyl ve stavu selected žádný RadioButton. Vždy jeden RadioButton ze
//   skupiny je ve stavu selected.
public class HRadioButtonTest extends Application {
