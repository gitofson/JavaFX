...
// Labeled controls disponují tzv. mnemonics, také známými jako klávesové zkratky (keyboard shortcuts, keyboard
// indicators). Jedná se o klávesu, která pošle ActionEvent ovládacímu prvku. Velmi často se daná klávesa stiskne
// s nějakým modifikátorem (nejčastějo Alt).
...
// Scéna také podporuje akcelerační klávesy (accelerators keys). Pokud je akcelerační klávesa stisknuta, spustí
// Runnable úlohu. Zatímco mnemonická klávesa je asociovaná s ovládacím prvkem a v případě jejíjo stisku pošle patřičný
// ActionEvent, akcelerační klávesa je přímo asociovaná k nějakému vláknu. Třída Scene udrčuje valstonst
// ObservableMap<KeyCombination, Runnable> accelerators.
// Způsob jak skrýt scénu stiskem klávesy:
...
public class BMnemonicTest extends Application {
