...
// Aby byl ListView editovatelný, je potřeba
//  - vlastnost editable nastavit na true,
//  - nastavit vlastnost Callback<ListView<String>, ListCell<String>> cellFactory na takovou CellFactory,
//    která produkuje editovatelný ListCell.
// ListView obsahuje vlastnost editingIndex, která obsahuje index právě editované položky. Pokud se nic needituje,
// obsahuje -1

// následující program ukazuje jak editovat položku ListView v TextField. Používá ListView<Person> a ListView<String>.
// Double klik umožní editaci, enter odešle editovanou položkou.
public class RListViewEditing extends Application {
