...
//Slider umožňuje vybrat numerickou hodnotu použitím grafického prvku. Vlastnosti:
// min
// max
// value
// valueChanging
// snapToTicks      - true, pokud je slider zarovnáván se značkami. Default false,
// majorTickUnit    - double, udává vydálenost mezi dvěma značkami,
// minoTickCount    - int, početminoritních značek mezi 2 majoritními,
// blockIncrement   - double, o kolik se má hodnota slideru změnit, použuíjeme-li klávesnici,
// showTickMarks
// showTickLabels
// labelFormatter   - StringConverter<Double> - zobrazení numerických hodnot majoritních značek.
public class ZJSliderTest extends Application {
