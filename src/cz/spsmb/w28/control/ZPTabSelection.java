...
// Následující program přidává selection-changed event handler oběma tabům. ChangeListener je přidán do
// vlastnosti selectedItem vlastnosti selectionModel.
public class ZPTabSelection extends Application {
