...
//Následující program ukazuje Label a TextField. Přidává key-typed event handler do TextField, který zkonzumuje událost,
// pokud znak není písmeno.

public class OKeyTyped extends Application {
