...
// Okenní událost (window event) nastane, pokud je okno zobrazeno, skryto, či zavřeno. WindowEvent disponije
// následujícími konstantami:

// ANY              - supertyp ostatní okenních událostí,
// WINDOW_SHOWING   - nastane před zobrazením okna,
// WINDOW_SHOWN     - nastane po zobrazení okna,
// WINDOW_HIDING    - nastane před skrytím okna,
// WINDOW_HIDDEN    - nastane po skrytí okna.
// WINDOW_CLOSE_EREQUEST - nastane, když je externí požadavek na zavření okna

//Následující program ukazuje jak použít všechny typy okenních událostí:

public class PWindowsEventApp extends Application {
    ...
    public void handle(WindowEvent e) {
        ...
        if (type == WindowEvent.WINDOW_CLOSE_REQUEST && !canCloseCbx.isSelected()) {
            e.consume();
        }
