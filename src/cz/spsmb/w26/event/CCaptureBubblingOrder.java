...
// Pořadí volání filtrů a handlerů:
// Filtry událostí jsou volány před handlery a od nejvyššího rodiče k event target. První je tzv. capture fáze, kde
// se volají filtry od nejvyššího rodičovského uzlu k uzlu, na který se událost vztahuje (event target). Druhá je tzv.
// bubbling fáze, kde se volahí handlery od event target k nejvyššímu rodičovskému uzlu.





public class CCaptureBubblingOrder extends Application {
