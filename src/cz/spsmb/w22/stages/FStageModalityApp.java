...
// Rozlišujeme dva typy oken:
// modální (modal)       - pokud je zobrazeno, uživatel nemůže manipulovat s ostatními okny, dokud modální okno nezmizí
// nemodální (modalless) - běžný případ okna, uživatel může manipulovat s libovolnými okny.

//JavaFX poskytuje 3 typy modálnosti:
// NONE              - výchozí, okno neblokuje žádné jiné = nemodální okno
// WINDOW_MODAL      - stage může mít nastaveného vlastníka pomocí metody initOwner(Window owner). Ten by měl být nastaven před
//                     voláním stage.show(). Typ modality WINDOW_MODAL blokuje všechna okna ve vlastníkově hierarchii.
// APPLICATION_MODAL - plná modálnost. Ostatní okna dané plikace nelze používat, dokud toto okno není zavřeno.
public class FStageModalityApp extends Application {
