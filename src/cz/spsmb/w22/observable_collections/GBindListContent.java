...
//metody bindContent() a bindContentBidirectional() umožňují navázat obsah ObservalbleListu, který je obalen ListProperty
// na obsah dalšího ObservableListu.
public class GBindListContent {
