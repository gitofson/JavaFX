...
// Vlastnost tileAlignment specifikuje výchozí zarovnání všech poduzlů (children) uvnitř dlaždic.
// Výchozí hodnota je Pos.CENTER
public class XTilePaneTileAlignment extends Application {
