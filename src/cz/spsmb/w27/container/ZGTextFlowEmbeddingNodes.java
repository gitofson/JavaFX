...
// TextFlow umožňuje kromě Text uzlů zapouzdřit i jiné typy. Následující program ukazuje zapouzdření RadioButton,
// TextField a Button do TextFlow:
public class ZGTextFlowEmbeddingNodes extends Application {
