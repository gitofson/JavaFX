...
// BorderPane dělí okno na pět oblastí: horní (top), pravou (right), dolní (bottom), levou (left) a střední (center).
// V každé z oblastí je možné přidat pouze jeden uzel. V typické win aplikaci se obrazovka dělí na pět oblastí:
// Menu, resp. toolbar nahoře,
// status bar dole,
// navigační panel vlevo,
// přídavné informace vpravo,
// hlavní obsah uprostřed.

// BorderPane tak splňuje požadavky pro typickou Windows-based GUI screen. To je důvod, proč je BorderPane
// nejpoužívanějším kořenovým uzlem pro scénu.
// BorderPane používá následující pravidla pro změnu velikostí poduzlů:
// - velikost poduzlů v top a bootom regionech nastavena na jejich preferovanou výšku,
// - velikost poduzlů v right a left regionech nastavena na jejich preferovanou šířku,
// - poduzel v ceter regionu vyplňuje zbytek volného místa v obou rozměrech.

// Následující program ukazuje jak vytvořit BorderPane a nastavit mu poduzly:

public class RBorderPaneTest extends Application {
