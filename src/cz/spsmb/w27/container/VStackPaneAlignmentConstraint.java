...
// StackPane umožňuje též nastavit zarovnání individuálních poduzlů zvlášť pomocí statické metody
// StackPane.setAlignment(Node node, Pos position).

public class VStackPaneAlignmentConstraint extends Application {
