...
// Pokud chceme i tlačítka rozšiřovat společne s VBoxem, musíme jim nastavit patřičnou maximum width
// (Zde Double.MAX_VALUE). Následující program toto ukazuje:
public class NVBoxFillWidth extends Application {
