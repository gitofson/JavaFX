...
// Vlastnost alignment definuje způsob výchozího zarovnávání poduzlů StackPane. Výchozí hodnota je  Pos.CENTER. Následující
// program ukazuje  5 StackPanes v HBoxu s různým zarovnáváním.
public class UStackPaneAlignment extends Application {
