...
//Třída HostServices poskytuje služby, které se týkají prostředí kde se aplikace spouští (desktop, web browser, nebo WebStart).
//Způsob získání instance třídy HostServices: HostServices host = getHostServices(); Obsahuje následující metody:
// String getCodeBase()         - vrací URI aplikace. Pokud je je aplikace v tzv. "stand-alone" módu, vrací URI adresáře
//                                který obsahuje JAR soubor použitý pro spuštění. Pokud je aplikace spuštěna pomocí class
//                                souboru, vrátí prázdný řetězec. Pokud je aplikace spuštěna pomocí JNLP souboru, vrátí
//                                patřičnou hodnotu, která je specifikována uvnitř JNLP souboru.
// String getDocumentBase       - v připadě webové aplikace vrací URI webové stránky, která aplikaci obsahuje.
// String resolveURI(String base, String relativeURI)
// void showDocument()          - otevře specifikované URI v novém okně prohlížeče.
public class GKnowingHostDetailsApp extends Application {
