...
// Mějme HBox s nekolika tlačítky. Pokud jedno z tlačítek se stane neviditelným, nechceme tam mít mezeru. Potom ale je třeba
// dát neviditelné tlačítko také unmanaged. Nejlépe přímo přibindováním:
// b2.managedProperty().bind(b2.visibleProperty());
public class ISlidingLeftNodeTest extends Application {
