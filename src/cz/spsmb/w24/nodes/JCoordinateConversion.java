...
//Občas je potřeba změnit souřadnice nějakého bodu z jednoho sořadnicového systému na jiný. Uzly umožňují následující transformce:
// localToParent()      - použito v příkladu
// localToScene()
// parentToLocal()
// sceneToLocal()
public class JCoordinateConversion extends Application {
