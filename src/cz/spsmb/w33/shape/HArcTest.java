...
// Třída Arc (oblouk) reprezentuje výseč elipsy. 7 vlastností:
// centerX, centerY     -
// radiusX, radiusY     -
// startAngle           - počáteční úhel ve stupních oblouku měřený od kladné osy x v protisměru hodinových ručiček,
// length               - úhel ve stupních, který začíná na začátku oblouku a končí na konci oblouku,
// type                 - možnosti:
//                  ArcType.OPEN        - oblouk se neuzavírá,
//                  ArcType.CHORD       - uzavření oblouku úsečkou,
//                  ArcType.ROUND       - uzavření úsečkami od středu pomyslné elipsy.
public class HArcTest extends Application {
