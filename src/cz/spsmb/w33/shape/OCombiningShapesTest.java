...
// Pro realizaci sjednocení, průniku, či rozdílu tvarů třída Shape nabízí následující metody:
// Shape union(Shape shape1, Shape shape2),
// Shape intersect(Shape shape1, Shape shape2),
// Shape substract(Shape shape1, Shape shape2),

public class OCombiningShapesTest extends Application {
