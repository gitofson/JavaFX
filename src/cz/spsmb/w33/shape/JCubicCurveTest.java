...
// Bezierovy křivky jsou používány v počítačové grafice ke kreslení vyhlazených křivek. Instance třídy CubicCurve
// reprezentuje kubickou Bezierovu křivku průnikem dvou specifikovaných bodů a dvěma kotrolními body.
// Více: https://cs.wikipedia.org/wiki/B%C3%A9zierova_k%C5%99ivka . 6 vlastností:
// startX, startY       - startovní bod křivky,
// controlX1, controlY1 - první kontrolní bod křivky,
// controlX2, controlY2 - druhý kontrolní bod křivky,
// endX, EndY           - koncový bod křivky.
public class JCubicCurveTest extends Application {
