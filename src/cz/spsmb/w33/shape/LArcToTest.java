...
// Třídy:
// HLineTo      - vykreslí horizontální čáru od současného bodu do bodu, specifikovaným x souřadnicí,
// VlineTo      - vykreslí vertikální čáru od současného bodu do bodu, specifikovaným y souřadnicí,,
// VArcTo       - vykreslí segment elipsy.

// Třídy VArcTo obsahuje následující vlastnosti:
// radiusX, radiusY     - poloměry elipsy,
// x, z                 -
// XAxisRotation
// largeArcFlag         - true, pokud se má vybrat delší výseč,
// sweepFlag            - true, pokud se má vybrat konvexní výseč.
public class LArcToTest extends Application {
    private ArcTo arcTo;
